...
Last updated: 2026-05-15 — `v0.4.1` npm publication verified, Python reference package verified on PyPI, Sage Ergo testnet settlement evidence archived, x402 stub pilot evidence archived, and mainnet gates still default-deny.
